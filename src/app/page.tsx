...
export const metadata: Metadata = {
  ...
  keywords: ["Sabbir", "Sabbir Ahmed", "Sabbir Software Engineer", "Sabbir CSE", "Sabbir Engineer", "Software Engineer", "Full Stack Developer", "CSE Graduate", "Web Developer", "Backend Engineer", "Sabbir Codemypixel", "Sabbir Uvoy"],
  openGraph: {
    title: "Sabbir Ahmed - Software Engineer | CSE Graduate | Full Stack Developer",
