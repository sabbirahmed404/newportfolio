...
const skills = [
  ...
  { id: 6, icon: SiReactquery, text: "Tanstack Query" },
  ...
  { id: 17, icon: SiPostman, text: "Postman" },
  { id: 18, icon: FaGitAlt, text: "Git" },
  { id: 19, icon: FaGithub, text: "GitHub" },
  ...
  { id: 26, icon: SiVercel, text: "Vercel" },
  { id: 27, icon: PiFigmaLogoBold, text: "Figma" },
]
